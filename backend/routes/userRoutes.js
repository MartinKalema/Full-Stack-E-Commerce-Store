...
// When a POST request is sent to the root URL '/', it triggers the createUser function.
// When a GET request is sent to the root URL '/', it triggers the middleware functions sequentially.
// getAllUsers only executes if the user is successfully authenticated and authorized as an admin.
